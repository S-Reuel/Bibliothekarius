...
class LivrosTest < ApplicationSystemTestCase
  ...
  test "should create livro" do
    ...
    fill_in "Data publicacao", with: @livro.data_publicacao
    fill_in "Nivel preferencia", with: @livro.nivel_preferencia
    fill_in "Preco", with: @livro.preco
    fill_in "Quantidade disponivel", with: @livro.quantidade_disponivel
    fill_in "Quantidade total", with: @livro.quantidade_total
    fill_in "Resumo", with: @livro.resumo
